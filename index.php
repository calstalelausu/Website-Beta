...
<body>
	...
	<div class="wrap">
		...
		<ul class="wrap-nav">
			...
			<ul>
				<ul>
							<li><a class="deptLink" href="/xtremefitness"> Xtreme Fitness </a></li>
					
					
				<li><a class="deptLink"  href="/pit"> The Pit</a></li>     
				</ul>
			</ul>
				<a class="deptHeading" href="#">Graffix</a>	
					...
					<ul>
				<ul>
							<li><a class="deptLink"  href="/acui">ACUI Awards</a></li>
						</ul>
			</ul>
				...
				<ul>
					...
					<li><a class="deptLink"  href="/meetingrooms.php">Meeting Rooms</a></li>  
					
						<li><a class="deptLink"  href="/Applications.php" title="Menu option 'Forms'">Forms</a></li>
			...
			<li><a class="deptHeading" hxref="#">Cross Cultural Centers</a>
			<ul>
				<li><a class="deptLink"   href="/apisrc">Asian Pacific Islander<br/> Student Resource Center</a></li>
							
							<li><a class="deptLink"   href="/clsrc">Chicana/o Latina/o<br/>	Student Resource Center</a></li>
							<li><a class="deptLink"   href="/ccc-cgc">Cultural Graduate Celebrations</a></li>
							<li><a class="deptLink"   href="/women.php">Distinguished Women Awards</a></li>
							<li><a class="deptLink"   href="/gsrc">Gender and Sexuality Resource Center</a></li>
							<li><a class="deptLink"  href="/leadershipforsocialjustice">Leadership For Social Justice Series</a></li>
							<li><a class="deptLink"   href="/allyship">LGTQIA+ Allyship<br/> Training</a></li>
							<li><a class="deptLink"   href="/ccc-goals">Operations, Goals, and<br/> Learning Outcomes</a></li>
							<li><a class="deptLink"   href="/pasrc">Pan African Student<br/>	Resource Center</a></li>
							<li><a class="deptLink"   href="/ccc-services">Services & Resources</a></li>
							<li><a class="deptLink"   href="/wocc">Womyn and Femmes Of Color Symposium</a></li>
				...
				<li><a class="deptHeading" href="#">Center For Student Involvment</a>
			<ul>
				<li><a class="deptLink"  href="#">Activities, Programs,<br/> and Trips</a></li>
				<li><a class="deptLink"  href="#">Eagles Care</a></li>
				<li><a class="deptLink"  href="#">Fraternity &amp; Sorority Life</a></li>
				<li><a class="deptLink"  href="/GEEK">Golden Eagle Event Krew (GEEK)</a> </li>
				<li><a class="deptLink"  href="https://www.calstatela.edu/studentservices/golden-eagle-handbook" target="_blank">Golden Eagle Handbook</a></li>
				<li><a class="deptLink"  title="Leadershape Institute" href="/leadershape.php">LeaderShape&nbsp;</a></li>
							<li><a class="deptLink"  href="/leadership-academy">Leadership Academy</a></li>
							<li><a class="deptLink"  href="/leap">Leadership Exploration And Advancement Program (L.E.A.P.)</a></li>
							<li><a class="deptLink"  href="/LeadershipRetreat.php">Leadership Retreat (FLY)</a></li>
							<li><a  class="deptLink"  href="/music">Music & Talent </a></li> 
							<li><a class="deptLink"  href="/sla">Student Leader Awards</a></li>
							<li><a class="deptLink"  href="/studentorglist">Student Organizations</a></li>
							<li><a class="deptLink"  href="/csi-forms">Student Organization<br/>	Handbook, Forms, and Policies</a> </li>
							<li><a class="deptLink" 	href="/ulead">U-Lead</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="blog-box">
                            ...
                            <div class="blog-desc">
                                <h4><a href="blog-single.html">THE CROSS CULTURAL CENTER GETS DOWN: Karaoke</a></h4>
